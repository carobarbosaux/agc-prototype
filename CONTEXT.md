...
Prototipo navegable de alta fidelidad de **AGC 2.0** — plataforma de creación de contenido educativo para UNIR. Fase 2 de 4 del producto (ver plan global en `AGC_ClaudeCode_Plan_v2_1.md`).
...
*Plan completo del producto: `AGC_ClaudeCode_Plan_v2_1.md`*
*Plan global de las 4 fases: `AGC — Plan de Producto`*
