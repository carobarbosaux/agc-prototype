...
export const bloquesIndice = [
  {
    ...
    tipo: 'ol',
    contenido:
      'Introducción al aprendizaje automático — Definición, historia y aplicaciones reales. Paradigmas de aprendizaje: supervisado, no supervisado y por refuerzo. Pipeline estándar de un proyecto ML. Conceptos de sobreajuste, infraajuste y bias-variance tradeoff.',
  ...
  },
  {
    ...
    tipo: 'ol',
    contenido:
      'Regresión y clasificación — Regresión lineal simple y múltiple. Regresión logística y función sigmoide. Algoritmo KNN. Métricas de evaluación: MSE, RMSE, precisión, recall, F1-score. Matriz de confusión.',
  ...
  },
  {
    ...
    tipo: 'ol',
    contenido:
      'Árboles de decisión y métodos ensemble — Árboles de decisión: criterios de división (Gini, entropía). Random Forest y bagging. Gradient Boosting y XGBoost. Interpretabilidad de modelos basados en árboles.',
  ...
  },
  {
    ...
    tipo: 'ol',
    contenido:
      'Redes neuronales básicas — Perceptrón y función de activación. Arquitectura de red feedforward. Retropropagación del error (backpropagation). Optimizadores: SGD, Adam. Introducción a frameworks: PyTorch y TensorFlow.',
  ...
  },
  {
    ...
    tipo: 'ol',
    contenido:
      'Evaluación y validación de modelos — Validación cruzada k-fold. Búsqueda de hiperparámetros: Grid Search, Random Search, Bayesian Optimization. Curvas ROC y AUC. Detección y corrección de data leakage.',
  ...
  },
  {
    ...
    tipo: 'ol',
    contenido:
      'Proyecto final integrador — Desarrollo end-to-end de un pipeline ML sobre un dataset real. Preprocesamiento, modelado, evaluación y presentación de resultados. Uso de MLflow para tracking de experimentos.',
